"""
Descripción:
Este módulo contiene métodos para la obtención de datos metereológicos
por medio del web scraping de la página de Weather Underground.
...
def obtenerDatos_WU(estación,día,mes,año,latitud,longitud,altura=None):
    ...
    if altura == None:
        path_altura = _path_script + "/../Recursos/CONUS/Altitud_CONUS_2km.h5"
        path_nc     = _path_script + "/../Recursos/NetCDF/BANDA13_G16_CONUS_1500_2500.nc"
        ...
        with h5py.File(path_altura,"r") as datos_altura:
            ...
            px_x , px_y  = GOES.coordenadas2px(nc,latitud=latitud,longitud=longitud)
