"""
Descripción:
Módulo que contiene las clases y métodos que permiten
la sincroización de datos con información temporal
para la construcción de series de tiempo con uno o 
más tipos de datos distintos.
